...
return [
    ...
    'leverage' => "杠杆",
    'terms_1' => "我承认我已阅读并理解作为此申请的一部分提供在线的风险警告通知。我明白关键信息文件在 Lucky Ant Trading Ltd (“Lucky Ant Trading Ltd”)网站上对我可用。",
    'terms_2' => "我承认我已阅读、理解并接受作为此申请的一部分提供在线的客户协议。",
    'terms_3' => "我理解 Lucky Ant Trading Ltd 将不会在其平台上为我提供任何关于交易的投资建议。",
    'terms_4' => "我确认我已阅读、理解并同意受 Lucky Ant Trading Ltd 隐私政策的约束。",
    'terms_5' => "我理解作为此申请的一部分提交的个人信息将用于通过第三方身份验证服务验证我的身份。",
    'terms_6' => "我确认我提供给您并插入在此表格中的信息是正确的，并且我承认如果这些信息发生任何变化，我将立即通知 Lucky Ant Trading Ltd。",
    'terms_7' => "我确认我已按照此申请中指定的自己的名义行事，并且在与此客户关系相关的所有事项中未代表第三方。因此，与 Lucky Ant Trading Ltd 账户有关的所有存款和交易资金都是我的个人资金。",
    'terms_8' => "我承认我已阅读，MT5账户的激活有效期为2个星期。如果在此期间未完成激活，系统将自动将该账户标记为无效，并进行删除处理，以确保账户的有效性和系统的安全性。",
    'terms_9' => "我已阅读、理解并同意受 Lucky Ant Trading Ltd 存款和提款政策的约束。",
    ...
    'insufficient_balance' => "结余不足",
    'insufficient_wallet_balance' => ":wallet结余不足",
...
//    'hofi_strategy' => "HOFI 智链",
    ...
    'hofi_copy_trading' => "AI 智链跟单社区",
    'alpha_copy_trading' => "交易汇站跟单社区",
    'hofi_pamm_trading' => "AI 智链 PAMM 交易",
    'alpha_pamm_trading' => "Alpha PAMM 交易",
    'loading_caption' => "加载选项",
    'no_available_accounts' => "无可用账户",
    'lock_free' => "无期",
    ...
    'notice' => "投资组合",
    'strategy' => "策略",
    "amount_entered_exceed" => "输入金额超过限制",
    "filter_by_tags" => "筛选标签",
    "no_min" => "无最低",
    "zero_fee" => "零费用",
    'copy_trading' => "跟单社区",
    'joined' => "加入时间",
    'hofi_subscriptions' => "AI 智链订阅",
    'alpha_subscriptions' => "交易汇站订阅",
    'export' => "导出",
    'mature' => "完成",
    ...
    'available_balance_to_withdraw' => "可提现金额",
    'receive_amount' => "接收金额",
    'select_account' => "选择账户",
    'add_account_suffix' => "前往个人资料添加支付账户",
    'no_security_pin' => "您似乎没有设置安全密码。",
    'add_security_pin_suffix' => "前往个人资料添加安全密码",
    'verify_kyc' => "验证身份",
    ...
    "announcement" => "通告",
    "update_payment_account" => "更新支付账户",
    "missing_fields" => "缺少资料",
    "account_missing_fields" => "您的账户缺少一些资料。",
    "update_payment_account_caption" => "请到支付账户以更新支付账户缺失资料。",
    "region_of_bank_placeholder" => "请填写（省）和（市）",
    "application" => "申请",
    "apply_form" => "申请表",
    "applicant_enrollment" => "申请人注册",
    "applicant_detail" => "申请人详情",
    "transport_information" => "交通信息",
    "applicant" => "申请人",
    "applicant_enrollment_count" => "申请人注册数量",
    "ic_passport_number" => "身份证/护照号码",
    "request" => "请求",
    "transport" => "交通",
    "accommodation" => "住宿",
    "ib_training" => "IB 培训",
    "no_transport_required" => "无需交通",
    "no_transport_required_caption" => "看起来不需要交通。您可以继续下一步进行最终检查。",
    "final_check" => "最终检查",
    "additional_information" => "附加信息",
    "transport_details_for" => "交通详情 -",
    ...
    "please_choose" => "请选择",
    "is_applicant_gold_team" => "是否是黄金战队人员？",
    "is_applicant_attend_training" => "是否出席三同内训会？",
    "no" => "否",
