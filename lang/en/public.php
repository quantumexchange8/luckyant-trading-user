...
return [
    ...
    "purchase_product_desc" => "To purchase agarwood trees",
...
//    'hofi_strategy' => "HOFI Connect",
    ...
    'hofi_copy_trading' => "AI Copy Trading",
    'alpha_copy_trading' => "Alpha Copy Trading",
    'hofi_pamm_trading' => "AI PAMM Trading",
    ...
    'copy_trading' => "Copy Trading",
    'joined' => "Joined",
    'hofi_subscriptions' => "AI Subscriptions",
    'alpha_subscriptions' => "Traders Hub Subscriptions",
    'export' => "Export",
    'mature' => "Mature",
    ...
    "applicant_enrollment" => "Applicant Enrollment",
    "applicant_detail" => "Applicant Detail",
    "transport_information" => "Transport Information",
    "applicant" => "Applicant",
    "applicant_enrollment_count" => "Applicant Enrollment Count",
    "ic_passport_number" => "IC/Passport Number",
    "request" => "Request",
    "transport" => "Transport",
    "accommodation" => "Accommodation",
    "ib_training" => "IB Training",
    "no_transport_required" => "No Transport Required",
    "no_transport_required_caption" => "Seems that there are no transportation required. You can proceed to next step for final checking.",
    "final_check" => "Final Check",
    "additional_information" => "Additional Information",
    "transport_details_for" => "Transport Details for",
    ...
    "product_redemption_list" => "Product Redemption List",
];
