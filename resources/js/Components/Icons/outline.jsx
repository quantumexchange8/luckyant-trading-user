...
export const CoinsStacked02Icon = defineComponent({
    setup() {
        return () => (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
...
export const LeverageIcon = defineComponent({
    setup() {
        return () => (
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M5.83333 16.6667H14.1667M5 5L10 4.16667L15 5M5 5L7.5 10C7.5 10.663 7.23661 11.2989 6.76777 11.7678C6.29893 12.2366 5.66304 12.5 5 12.5C4.33696 12.5 3.70107 12.2366 3.23223 11.7678C2.76339 11.2989 2.5 10.663 2.5 10L5 5ZM15 5L17.5 10C17.5 10.663 17.2366 11.2989 16.7678 11.7678C16.2989 12.2366 15.663 12.5 15 12.5C14.337 12.5 13.7011 12.2366 13.2322 11.7678C12.7634 11.2989 12.5 10.663 12.5 10L15 5ZM10 2.5V16.6667"
