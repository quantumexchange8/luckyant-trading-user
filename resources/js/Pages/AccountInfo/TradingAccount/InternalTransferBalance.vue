...
<template>
    <form class="space-y-2">
        <div class="flex flex-col sm:flex-row gap-4">
            <Label class="text-sm dark:text-white w-full md:w-1/4 pt-0.5" for="wallet" value="Transfer To" />
            <div class="flex flex-col w-full">
                ...
                <span class="text-sm text-gray-600 dark:text-gray-400 mt-2">Transfer from: {{ account.meta_login }} - ${{ account.balance ? formatAmount(account.balance) : '0.00' }}</span>
            </div>
        </div>
