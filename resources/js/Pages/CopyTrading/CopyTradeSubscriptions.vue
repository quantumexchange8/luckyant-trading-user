...
const getResults = async (filterJoinDate = null) => {
    ...
    try {
        let url = `/${props.strategyType}_strategy/getCopyTradeSubscriptions?meta_login=${meta_login.value}&master_id=${master_id.value}`;
...
<template>
    <div v-if="copyTradesCount > 0" class="flex flex-col gap-5 items-start self-stretch">
        <SubscriptionAccount
                    ...
                    >
                        ...
                        <template v-if="subscriptions.length">
                            ...
                            >
                                ...
                                <template #body="slotProps">
                                    {{ slotProps.data.subscription_period ?? 0 }} {{ $t('public.days') }}
                                </template>
                            </Column>
                            <Column
                                field="join_day"
