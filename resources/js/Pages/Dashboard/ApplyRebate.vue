...
const applyRebateModal = ref(false);

const openApplyRebateModal = () => {
    applyRebateModal.value = true;
}

const closeModal = () => {
    applyRebateModal.value = false;
}
</script>
...
<template>
    ...
    <Modal :show="applyRebateModal" title="Apply Rebate" @close="closeModal">
