...
import PammMasters from "@/Pages/Pamm/PammListing/PammMasters.vue";

const props = defineProps({
    terms: Object,
    getTradingAccounts: Array,
})
...
const search = ref('');
const master = ref('');
const meta_login = ref(props.getTradingAccounts[0].value);
